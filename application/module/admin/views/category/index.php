...
<?php
    ...
    $url_edit           = URL::createURL("admin", "category", "form");
    $url_delete         = URL::createURL("admin", "category", "delete");
    $url_multiDelete    = URL::createURL("admin", "category", "multiDelete");
    $url_multiPublic    = URL::createURL("admin", "category", "multiPublic");
    $url_multiUnpublic  = URL::createURL("admin", "category", "multiUnpublic");
        ...
        <div class="box box-info">
            ...
            <form action="#" id="adminForm" method="POST">
                    ...
                    <div class="input-group input-sm" style="margin-bottom:30px">
                        <div class="input-group-btn typing_search">
                            ...
                            <ul class="dropdown-menu">
                                <li role="category_descript" ><a href="#">Select by Descript</a></li>
                ...
                <div class="col-md-6">
                    ...
                    ?>
                        <select class="form-control input-sm" id="select_filter_category" name="select_filter_category" size="1">
                ...
                <div id="example2_wrapper" class="dataTables_wrapper form-inline" role="grid">
                    <table id="example2" class="table table-bordered table-hover dataTable text-center">
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" width="15%"><?php echo $lbPicture ?></th>
                                <th class="sorting" width="7%"><?php echo $lbStatus ?></th>
                        ...
                        <?php
                            ...
                            foreach($this->listCategory as $key => $value){
                                // echo htmlentities($value["category_descript"]);
                                $category_edit  = URL::createURL("admin", "category", "form", array("id" => $value["id"]) );
                                $status         = ($value["status"] == 1)? Helper::createPublicHTMLA( array("element" => "status", "id" => $value["id"], "controller" => "category"  )) : Helper::createUnpublicHTMLA( array("element" => "status", "id" => $value["id"], "controller" => "category") );
                                ...
                                $picture = PATH_PICTURE_CATEGORY . DS . RESIZE_60x90 . "-" . $value["picture"];
                                if(!file_exists($picture)){
                                    $picture = URL_PICTURE_CATEGORY . DS . RESIZE_DEFAULT_60x90;
                                }else{
                                    $picture = URL_PICTURE_CATEGORY . DS . RESIZE_60x90 . "-" . $value["picture"];
                                }
                                ...
                                $xhtml .= '<tr class="'.$class.'">
                                            ...
                                            <td class="">
                                                <div class="col-md-5">
                                                    <a href = '.$category_edit.'>'.$value["name"].'</a>
                                                </div>
                                                <div class="col-md-1">|</div>
                                                <div class="col-md-6">
                                                    <a href = '.$category_edit.'>'.$value["category_descript"].'</a>
                                                </div>
                                            </td>
                                            <td class="show_status_'.$value["id"].'"><img src="'.$picture.'"></td>
                    ...
                    <!-- FILTER -->
                    <input type="hidden" name="filter_name_category" value="default">
...
<?php
    // Gắn lại các select
    if(isset($this->params["select_filter_category"])){
        if($this->params["select_filter_category"] != "default")
        echo Helper::createScriptSelected("#select_filter_category", $this->params["filter_name_category"]);
    }
    // Gắn lại các select
